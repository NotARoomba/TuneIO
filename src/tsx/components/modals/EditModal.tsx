...
export default function EditModal({ isOpen, setIsOpen }: BaseModalProps) {
  ...
  return (
    <Modal
      ...
      isOpen={isOpen}
      className={
        " w-4/12 p-10 rounded-xl h-7/12 min-h-96 min-w-96 dark:bg-rich_black bg-paynes_gray/80 text-beige absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2  outline-2 outline outline-air_force_blue-200 " +
