...
export default function ResultsModal({
  ...
  return (
    <Modal
      ...
      isOpen={isOpen}
      className={
        " w-11/12 p-4 rounded-xl h-7/12 min-h-64 dark:bg-rich_black bg-paynes_gray/80 text-beige absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 outline-2 outline outline-air_force_blue-200 " +
